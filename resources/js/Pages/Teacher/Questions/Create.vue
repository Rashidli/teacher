...
const insertFormula = (field, formula, optionIndex = null) => {
    if (optionIndex !== null) {
        form.options[optionIndex].option_text += ` $${formula}$ `;
    } else {
        form[field] += ` $${formula}$ `;
    }
};
...
const submit = () => {
    form.post(route('teacher.exams.questions.store', props.exam.id), { forceFormData: true });
};
                    ...
                    <form @submit.prevent="submit" class="p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <div class="flex flex-wrap gap-1 mb-2">
                                <button
                                    v-for="s in mathShortcuts"
                                    :key="s.label"
                                    type="button"
                                    @click="insertFormula('question_text', s.formula)"
                        ...
                        <div>
                            ...
                            <div class="mt-2">
                                <div v-if="imagePreview" class="mb-3">
                                    <img :src="imagePreview" alt="Preview" class="max-w-xs rounded-lg border border-gray-200" />
                                ...
                                <div v-for="(option, index) in form.options" :key="index">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <TextInput
                                            ...
                                            :placeholder="`Variant ${String.fromCharCode(65 + index)} — formula üçün $...$ istifadə edin`"
                                            required
                                        />
